...
enum TokenType{
    ...
    ID, NUM,
    ENDFILE, ERROR , AND // here we added the token type which is AND word
};
...
const char* TokenTypeStr[]=
        {
                ...
                "ID", "Num",
                "EndFile", "Error", "And" // here the token type as a string
        };
...
// program -> Parse
void start_analyzer(CompilerInfo compiler_info){
